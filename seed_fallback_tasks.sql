...
INSERT INTO iota_v2.iota_pmo_tasks (
        ...
        '공통 PMO', '사업2파트', 'DEPT_PM2',
        '사업관리1파트;개발관리실;공간솔루션실;기업마케팅실;LFC', '미정', 'EXTERNAL',
        false, true, '2026-07-03', '진행중', '준공필수', '정규',
...
INSERT INTO iota_v2.iota_pmo_tasks (
        ...
        false, true, '2026-07-03', '진행중', 'PF필수', '정규',
...
INSERT INTO iota_v2.iota_pmo_tasks (
        ...
        true, true, '2026-07-15', '지연', 'PF필수', '정규',
...
INSERT INTO iota_v2.iota_pmo_tasks (
        ...
        false, true, '2026-07-31', '미착수', 'PF필수', '정규',
...
INSERT INTO iota_v2.iota_pmo_tasks (
        ...
        '공통 PMO', '사업2파트', 'DEPT_LFC',
        '사업2파트;기업마케팅실;공간솔루션실', '미정', 'STAKE_호텔브랜드사',
        false, false, '2026-08-15', '미착수', 'PF필수', '정규',
...
INSERT INTO iota_v2.iota_pmo_tasks (
        ...
        '공통 PMO', '사업2파트', 'DEPT_DEV',
        '사업2파트;LFC', '미정', 'STAKE_서울시중구청',
        true, true, '2026-07-19', '진행중', 'PF필수', '정규',
...
INSERT INTO iota_v2.iota_pmo_tasks (
        ...
        false, true, '2026-07-31', '진행중', 'PF필수', '정규',
...
INSERT INTO iota_v2.iota_pmo_tasks (
        ...
        '공통 PMO', '사업2파트', 'DEPT_DEV',
        '사업2파트;LFC', '미정', 'STAKE_서울시중구청',
        false, false, '2026-09-30', '미착수', '준공필수', '정규',
...
INSERT INTO iota_v2.iota_pmo_tasks (
        ...
        true, true, '2026-07-31', '진행중', 'PF필수', '정규',
...
INSERT INTO iota_v2.iota_pmo_tasks (
        ...
        true, false, '2026-08-15', '진행중', 'PF필수', '정규',
...
INSERT INTO iota_v2.iota_pmo_tasks (
        ...
        false, false, '2026-09-15', '미착수', '준공필수', '정규',
...
INSERT INTO iota_v2.iota_pmo_tasks (
        ...
        false, false, '2026-07-31', '진행중', 'PF필수', '정규',
...
INSERT INTO iota_v2.iota_pmo_tasks (
        ...
        false, false, '2026-08-15', '진행중', 'PF필수', '정규',
...
INSERT INTO iota_v2.iota_pmo_tasks (
        ...
        false, false, '2026-08-31', '미착수', 'PF필수', '정규',
        45, 'B', 'PF필수 / 지원:브랜드 기준자료',
...
INSERT INTO iota_v2.iota_pmo_tasks (
        ...
        false, true, '2026-08-15', '진행중', 'PF필수', '정규',
...
INSERT INTO iota_v2.iota_pmo_tasks (
        ...
        false, true, '2026-08-31', '미착수', 'PF필수', '정규',
...
INSERT INTO iota_v2.iota_pmo_tasks (
        ...
        false, true, '2026-07-12', '진행중', 'PF필수', '정규',
...
INSERT INTO iota_v2.iota_pmo_tasks (
        ...
        '공통 PMO', '사업2파트', 'DEPT_PM2',
        '전 부서', '미정', 'EXTERNAL',
        false, false, '2026-07-05', '진행중', '중간', '정규',
        15, 'B', '지원:부서별 피드백',
        NULL, '주간 업데이트 루틴 확정'
    ) ON CONFLICT DO NOTHING;
INSERT INTO iota_v2.iota_pmo_tasks (
        ...
        false, false, '2026-10-31', '미착수', '준공필수', '정규',
...
INSERT INTO iota_v2.iota_pmo_tasks (
        ...
        false, false, '2027-03-31', '미착수', '준공필수', '정규',
...
INSERT INTO iota_v2.iota_pmo_tasks (
        ...
        false, false, '2026-07-05', '미착수', '중간', '팝업',
        20, 'B', '지원:목적·기한 확인 / 팝업',
        '샘플', '팝업요청관리 시트로 이관'
    ) ON CONFLICT DO NOTHING;
