    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <p className="text-[38px] md:text-[44px] lg:text-[50px] font-bold text-left tracking-tight text-white leading-[1.3] max-w-[1200px] break-keep">
                        {lang === 'kr' ? (
                            <>
                                데이터의 연결과 최적화는<br className="hidden md:block"/>
                                가장 정밀한 <span className="text-[#3b82f6]">'리스크 매니지먼트'</span>이자,<br className="hidden md:block"/>
                                강력한 <span className="text-[#3b82f6]">'자본 조달의 무기'</span>가 됩니다.<br/><br/>
                                <span className="inline-block text-gray-300 font-normal text-[23px] md:text-[28px] lg:text-[32px] leading-[1.4]">
