    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <p className="text-[32px] md:text-[38px] lg:text-[44px] font-bold text-left tracking-tight text-white leading-[1.4] max-w-[1200px] break-keep">
                        {lang === 'kr' ? (
                            <>
                                ...
                                <span className="inline-block text-gray-300 font-normal text-[29px] md:text-[34px] lg:text-[38px] leading-[1.4]">
