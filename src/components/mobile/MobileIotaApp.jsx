...
export default function MobileIotaApp({ navigateTo }) {
    ...
    return (
        ...
        >
            ...
            {/* Bottom Navigation */}
            <div className="flex w-full bg-[#272726] border-t border-[#3c3c3c] shrink-0 pb-[calc(2px+env(safe-area-inset-bottom))]">
                {[
                    ...
                    <button 
                        ...
                        className={`flex-1 flex flex-col items-center justify-center pt-[10px] pb-[8px] relative ${activeTab === tab.id ? 'text-[#60a5fa]' : 'text-[#9A9A98]'}`}
                    >
