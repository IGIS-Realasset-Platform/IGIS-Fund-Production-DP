            ...
            <div className="w-full max-w-[1000px] mx-auto flex flex-col items-start justify-center text-left font-sans tracking-tight relative z-10 my-auto shrink-0 -translate-y-[40px] md:-translate-y-[50px] gap-0 pt-24 pb-32">
                ...
                <div className="overflow-hidden mt-12 md:mt-20">
                    ...
                    >
                        ...
                        {lang === 'kr' ? "를 " : " into a "}
                        <span className="text-[#297cf6] font-bold">{lang === 'kr' ? "천재" : "genius"}</span>
                        {lang === 'kr' ? "로 만드는 것은" : ""}
                    </p>
                </div>
                ...
                <div className="overflow-hidden mt-1 md:mt-2">
                    ...
                    >
                        ...
                        <span className="relative inline-block pb-[1px]">
                            <span className="text-[#297cf6] font-bold">
                                {lang === 'kr' ? "'풍부한 실무 데이터'" : "'Rich Production Data'"}
                            </span>
                            {/* 밑줄 렌더링 5스텝 분기 */}
                            <span 
                                className={`absolute bottom-[2px] left-0 h-[2px] md:h-[3px] bg-[#297cf6] -z-10 transition-all duration-[800ms] ease-[cubic-bezier(0.25,1,0.5,1)] ${step >= 5 ? 'w-full opacity-100' : 'w-0 opacity-0'}`}
                            ></span>
                        </span>
                        {lang === 'kr' ? "입니다." : "."}
                    </p>
                ...
                <div className="overflow-hidden mt-12 md:mt-20">
                    ...
                    >
                        ...
                        <span className="text-[#297cf6] font-bold">{lang === 'kr' ? "전사(Enterprise)" : "Enterprise"}</span>
