...
export default function Section9({ isActive }) {
    ...
    return (
        <section className="section w-full h-full bg-white relative overflow-hidden">
            ...
            {/* Mobile Fallback: Only shows when viewport is < md (768px) */}
            <div className="flex md:hidden absolute inset-0 z-50 bg-white items-center justify-center p-6 text-center h-[100vh]">
                <div className="flex flex-col items-center opacity-80">
                    ...
                    <p className="text-[15px] font-medium text-[#1d1d1f] tracking-tight leading-[1.6]">
            ...
            <div 
                className={`hidden md:flex w-full absolute left-0 top-0 transition-transform duration-[1500ms] ease-[cubic-bezier(0.19,1,0.22,1)]
