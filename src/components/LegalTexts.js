export const privacyTextKr = `[IOTA SEOUL] 개인정보 처리방침 (Updated 2026.03.11)
...
export const privacyTextEn = `[IOTA SEOUL] Privacy Policy (Updated Mar 11, 2026)
...
export const termsTextKr = `[IOTA SEOUL] 이용약관
...
export const termsTextEn = `[IOTA SEOUL] Terms of Service
