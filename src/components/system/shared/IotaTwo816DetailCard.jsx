                    ...
                    {isAccordionOpen && (
                        ...
                        >
                            <div className="p-[32px]">
                                ...
                                <div className="min-w-max border border-[#3C3C3C] rounded-lg bg-[#242426]">
                                    <div className="flex border-b border-[#3C3C3C] bg-[#2C2C2E]">
                                        <div className="sticky left-0 z-20 bg-[#2C2C2E] w-[150px] p-3 border-r border-[#3C3C3C] font-bold text-[#86868B] text-[13px] shrink-0 flex items-center rounded-tl-lg">지표 구분</div>
