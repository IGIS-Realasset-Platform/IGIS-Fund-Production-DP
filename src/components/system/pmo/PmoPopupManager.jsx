    ...
    return (
        <div className="w-[1290px] mx-auto flex-1 flex flex-col pt-[48px] pb-[200px] box-border select-text text-white bg-transparent">
            ...
            <div className="grid grid-cols-9 gap-2.5 mb-[12px]">
                ...
                >
                    <span className="text-[13px] font-bold text-[#86868B]">전체 요청</span>
                ...
                >
                    <span className="text-[13px] font-bold text-[#a1a1aa]">미착수</span>
                ...
                >
                    <span className="text-[13px] font-bold text-[#2997ff]">진행중</span>
                ...
                >
                    <span className="text-[13px] font-bold text-[#bf5af2]">검토중</span>
                ...
                >
                    <span className="text-[13px] font-bold text-[#ff9f0a]">대기</span>
                ...
                >
                    <span className="text-[13px] font-bold text-[#ff453a]">지연</span>
                ...
                >
                    <span className="text-[13px] font-bold text-[#30d158]">완료</span>
                ...
                >
                    <span className="text-[13px] font-bold text-[#ffd60a]">보류</span>
                ...
                >
                    <span className="text-[13px] font-bold text-[#8e8e93]">중단</span>
                        ...
                        <table className="text-left table-fixed border-collapse w-[1290px] min-w-[1290px] select-text">
                            <thead className="bg-transparent">
                                <tr className="border-b border-[#3c3c3c] h-[46px]">
                                    ...
                                    <th className="px-3 py-0 text-[13px] font-bold text-[#86868B] border-r border-[#3c3c3c]/50 w-[260px]">업무명</th>
