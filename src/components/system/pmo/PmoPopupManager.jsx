        ...
        <div className="w-[1290px] mx-auto flex-1 flex flex-col pt-[28px] pb-[200px] box-border select-text text-white bg-transparent">
            ...
            <div className="w-full flex justify-between items-end mb-[18px]">
                <div className="flex flex-col text-left">
                    <h1 className="text-[24px] font-bold text-white tracking-tight leading-none mb-[8px]">단발성 업무 요청</h1>
            ...
            <div className="grid grid-cols-9 gap-2.5 mb-[12px]">
                ...
                <div 
                    ...
                    className={`py-2 px-1.5 rounded-[12px] border transition-all cursor-pointer flex flex-col items-center justify-center text-center ${filterStatus === '검토중' ? 'bg-[#bf5af2]/10 border-[#bf5af2] shadow-md shadow-[#bf5af2]/5' : 'bg-[#2c2c2b]/60 border-[#3c3c3c] hover:border-[#555]'}`}
                >
