...
export default function PmoMeetingMain() {
    ...
    return (
        <div className="w-full flex-1 flex flex-col pt-[28px] pb-[60px] max-w-[1200px] mx-auto select-text">
            ...
            <div className="w-[calc(100%+14px)] ml-[-7px] border border-[#4b4b4b] rounded-[34px] p-[6px] flex flex-col gap-[6px] mb-[32px] select-none text-center bg-transparent">
                {/* Upper Row Box */}
                <div className="grid grid-cols-5 bg-[#b4b6b5] h-[86px] rounded-[24px] overflow-hidden divide-x divide-[#8b8b8b]">
                    {upperFilters.map((btn, idx) => (
                        ...
                        >
                            <div className="w-full h-full rounded-[20px] bg-transparent group-hover:bg-[#d4d7d5] transition-all duration-200 flex flex-col items-center justify-center">
                ...
                {/* Lower Row Box */}
                <div className="grid grid-cols-8 bg-[#2b2b2b] h-[86px] border border-[#4b4b4b] rounded-[24px] overflow-hidden divide-x divide-[#4b4b4b]">
                    {lowerFilters.map((btn, idx) => (
                        <div
                            ...
                            className="p-[6px] h-full flex items-center justify-center cursor-pointer group"
                        >
                            <div className="w-full h-full rounded-[20px] bg-transparent group-hover:bg-[#3e3e3e] transition-all duration-200 flex flex-col items-center justify-center">
