...
export default function PmoMeetingMain() {
    ...
    return (
        <div className="w-full flex-1 flex flex-col pt-[28px] pb-[60px] max-w-[1200px] mx-auto select-text">
            ...
            <div className="w-[calc(100%+14px)] ml-[-7px] border border-[#4b4b4b]/50 rounded-[40px] p-[6px] flex flex-col gap-[6px] mb-[32px] select-none text-center bg-transparent">
                {/* Upper Row Box */}
                <div className="grid grid-cols-5 bg-[#b4b6b5] h-[90px] rounded-[30px] overflow-hidden divide-x divide-[#8b8b8b]">
                ...
                {/* Lower Row Box */}
                <div className="grid grid-cols-8 bg-[#2b2b2b] h-[90px] border border-[#4b4b4b] rounded-[30px] overflow-hidden divide-x divide-[#4b4b4b]">
