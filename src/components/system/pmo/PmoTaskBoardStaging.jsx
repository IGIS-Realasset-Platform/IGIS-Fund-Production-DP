                                                ...
                                                <tr key={t.id || `task-${idx}`} className="group hover:bg-[#333]/50 transition-colors h-12">
                                                    ...
                                                    <td className="text-center font-bold text-[#E5E5E5] w-[90px] min-w-[90px] max-w-[90px] truncate sticky left-[60px] bg-[#272726] group-hover:bg-[#2d2d2c] transition-colors z-10">
                                                         <span className={`px-1.5 py-0.5 rounded text-[11px] font-bold border inline-block max-w-full truncate ${
                                                             projectVal === 'IOTA 공통' ? 'bg-[#242426] text-[#A2C2F8] border-[#323236]' :
                                                             projectVal === '427 PFV' ? 'bg-[#242426] text-[#FFD085] border-[#323236]' :
                                                             projectVal === '816 PFV' ? 'bg-[#242426] text-[#A6E8B9] border-[#323236]' :
                                                             projectVal === '421Fund' ? 'bg-[#242426] text-[#D8BFF8] border-[#323236]' :
                                                             'bg-[#242426] text-[#C7C7CC] border-[#323236]'
                                                         }`}>
                                                             {projectVal}
                                                         </span>
                                                    </td>
