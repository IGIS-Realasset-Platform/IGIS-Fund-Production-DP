...
export default function GovExternalComm() {
    const rulesData = [
        { partner: '시공사', window: '개발솔루션 <span className="text-[#E5E5E5] hover:text-[#2997FF] cursor-pointer transition-colors hover:underline underline-offset-4 decoration-[#2997FF]/50">홍장군</span>', backup: 'Co-PM <span className="text-[#E5E5E5] hover:text-[#2997FF] cursor-pointer transition-colors hover:underline underline-offset-4 decoration-[#2997FF]/50">권순일</span> / <span className="text-[#E5E5E5] hover:text-[#2997FF] cursor-pointer transition-colors hover:underline underline-offset-4 decoration-[#2997FF]/50">강순용</span>', auth: 'UW 범위 내 자율, UW 외는 PM/CFT 운영위 승인' },
        { partner: '설계사', window: '개발솔루션 설계담당(<span className="text-[#E5E5E5] hover:text-[#2997FF] cursor-pointer transition-colors hover:underline underline-offset-4 decoration-[#2997FF]/50">김대익</span>·<span className="text-[#E5E5E5] hover:text-[#2997FF] cursor-pointer transition-colors hover:underline underline-offset-4 decoration-[#2997FF]/50">장성진</span>)', backup: 'PM <span className="text-[#E5E5E5] hover:text-[#2997FF] cursor-pointer transition-colors hover:underline underline-offset-4 decoration-[#2997FF]/50">강순용</span>', auth: 'Alt 결정은 PM 단독, 상품 변경은 SSC 협의' },
        { partner: 'CM/감리', window: '개발솔루션 건설담당', backup: 'PM <span className="text-[#E5E5E5] hover:text-[#2997FF] cursor-pointer transition-colors hover:underline underline-offset-4 decoration-[#2997FF]/50">강순용</span>', auth: '월 1회 정기 보고, 사고 즉시 보고' },
        { partner: '증권사 (PF 주관)', window: 'LFC <span className="text-[#E5E5E5] hover:text-[#2997FF] cursor-pointer transition-colors hover:underline underline-offset-4 decoration-[#2997FF]/50">박준호</span>', backup: 'Co-PM <span className="text-[#E5E5E5] hover:text-[#2997FF] cursor-pointer transition-colors hover:underline underline-offset-4 decoration-[#2997FF]/50">권순일</span> / <span className="text-[#E5E5E5] hover:text-[#2997FF] cursor-pointer transition-colors hover:underline underline-offset-4 decoration-[#2997FF]/50">강순용</span>', auth: '리파이낸싱 옵션 상시 검토, 조건 변경은 운영위' },
        { partner: '대주단 (본PF·통합PF)', window: 'LFC <span className="text-[#E5E5E5] hover:text-[#2997FF] cursor-pointer transition-colors hover:underline underline-offset-4 decoration-[#2997FF]/50">박준호</span>', backup: '운용지원 자금팀', auth: 'Covenants 보드 월간, 위반 시 24시간 내 통지' },
        { partner: '잠재 임차인', window: 'EMC <span className="text-[#E5E5E5] hover:text-[#2997FF] cursor-pointer transition-colors hover:underline underline-offset-4 decoration-[#2997FF]/50">김민지</span>', backup: 'KAM 1파트 (운영기 이후)', auth: 'UW 범위 외 임대차는 운영위 결재' },
        { partner: 'LM사 (외주)', window: 'EMC <span className="text-[#E5E5E5] hover:text-[#2997FF] cursor-pointer transition-colors hover:underline underline-offset-4 decoration-[#2997FF]/50">고아라</span>', backup: 'KAM 1파트', auth: '성과 약정 KPI 분기 점검' },
        { partner: '규제 당국·지자체', window: '사업1파트 <span className="text-[#E5E5E5] hover:text-[#2997FF] cursor-pointer transition-colors hover:underline underline-offset-4 decoration-[#2997FF]/50">권순일</span>', backup: '개발솔루션 인허가(<span className="text-[#E5E5E5] hover:text-[#2997FF] cursor-pointer transition-colors hover:underline underline-offset-4 decoration-[#2997FF]/50">이정훈</span>)', auth: 'PFV 재구조화·국토부 협의는 권순일 단독' },
        { partner: 'LP (수익자)', window: 'KAM 1파트 <span className="text-[#E5E5E5] hover:text-[#2997FF] cursor-pointer transition-colors hover:underline underline-offset-4 decoration-[#2997FF]/50">김행단</span>', backup: 'CFT 총괄', auth: 'Q&A 단일 채널, 운영위 사전검토 필수' },
        { partner: '외부 법무·회계·감정 (IPR)', window: '프리츠 TFT <span className="text-[#E5E5E5] hover:text-[#2997FF] cursor-pointer transition-colors hover:underline underline-offset-4 decoration-[#2997FF]/50">권순일</span>', backup: 'PM <span className="text-[#E5E5E5] hover:text-[#2997FF] cursor-pointer transition-colors hover:underline underline-offset-4 decoration-[#2997FF]/50">강순용</span> (사실관계 한정)', auth: '자료 외부 반출 시 워터마크·로그' },
    ];
