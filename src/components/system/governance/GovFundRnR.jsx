...
export default function GovFundRnR() {
    return (
        <div className="w-full flex-1 flex flex-col pt-[77px] pb-[110px] max-w-[1112px] mx-auto">
            {/* Header */}
            <h1 className="text-[36px] font-bold text-white tracking-tight leading-none font-['Inter'] mb-[24px]">
                421호 펀드 운용 R&R
            </h1>
            <p className="text-[17px] text-[#A1A1AA] leading-[28px] mb-[64px]">
                421호 펀드는 이오타서울의 자본 공급 주체이자 LP의 신탁자이다. PFV의 개발 리스크가 펀드 수익자에게 직접 전이되지 않도록 명확한 방화벽과 보고 체계가 요구된다.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-[16px] mb-[64px]">
                <div className="bg-[#111] border border-[#333] rounded-[16px] p-[24px]">
                    <h3 className="text-[16px] font-bold text-white mb-[8px]">정기보고</h3>
                    <p className="text-[15px] text-[#A1A1AA] leading-[24px]">
                        분기보고서(KAM 1 파트 작성, CFT 총괄 승인),<br />월간 진척 노트(PM 작성, KAM 검토)
                    </p>
                </div>
                <div className="bg-[#111] border border-[#333] rounded-[16px] p-[24px]">
                    <h3 className="text-[16px] font-bold text-white mb-[8px]">비정기보고</h3>
                    <p className="text-[15px] text-[#A1A1AA] leading-[24px]">
                        UW 범위 외 사안 24 시간 내 통지,<br />대주단 Covenants 위반 가능성 식별 즉시 통지
                    </p>
                </div>
                <div className="bg-[#111] border border-[#333] rounded-[16px] p-[24px]">
                    <h3 className="text-[16px] font-bold text-white mb-[8px]">Q&A 응대</h3>
                    <p className="text-[15px] text-[#A1A1AA] leading-[24px]">
                        단일 채널 운용(KAM 1 파트가 게이트키퍼),<br />모든 답변은 운영위 사전 검토 후 발신
                    </p>
                </div>
                <div className="bg-[#111] border border-[#333] rounded-[16px] p-[24px]">
                    <h3 className="text-[16px] font-bold text-white mb-[8px]">연 1 회 IR Day</h3>
                    <p className="text-[15px] text-[#A1A1AA] leading-[24px]">
            ...
            {/* 9.2 자본콜·운용지시·자금집행 라인 */}
            <h2 className="text-[22px] font-bold text-white mb-[16px] tracking-tight">
                9.2 자본콜·운용지시·자금집행 라인
            </h2>
            <p className="text-[16px] text-[#A1A1AA] leading-[26px] mb-[32px]">
                자본콜은 PFV의 자금 수요 → PM 검증 → LFC 검토 → KAM 운용지시 → LP 통지 → 자금집행의 5단계로 표준화한다. 단계별로 결재선과 보존 문서가 정해진다.
            </p>
                    ...
                    {[
                        ...
                        <div key={idx} className="relative flex items-start py-[12px]">
                            ...
                            <div className="flex flex-col md:flex-row md:items-center gap-[4px] md:gap-[16px]">
                                <span className="text-[15px] font-bold text-[#E5E5E5] min-w-[180px]">{step.title}</span>
                                <span className="text-[15px] text-[#86868B]">{step.desc}</span>
                            </div>
                        </div>
                    ))}
                </div>
            ...
            <ul className="flex flex-col gap-[16px] mb-[64px] pl-[8px]">
                <li className="flex items-start">
                    <span className="text-[#86868B] mr-[16px] mt-[4px] text-[12px]">■</span>
                    <span className="text-[16px] text-[#A1A1AA] leading-[26px]">
            ...
            <div className="bg-[#111] border border-[#333] rounded-[24px] p-[32px]">
                <h3 className="text-[18px] font-bold text-[#E5E5E5] mb-[20px]">
                    3대 방화벽 원칙
                </h3>
                <div className="flex flex-col gap-[20px]">
                    <div className="flex items-start">
                        <span className="inline-flex min-w-[24px] text-[15px] font-bold text-[#86868B] mt-[2px]">1)</span>
                        <div>
                            <span className="text-[16px] font-bold text-[#E5E5E5] mr-[8px]">의사결정 분리 —</span>
                            <span className="text-[16px] text-[#A1A1AA] leading-[26px]">
                    ...
                    <div className="flex items-start">
                        <span className="inline-flex min-w-[24px] text-[15px] font-bold text-[#86868B] mt-[2px]">2)</span>
                        <div>
                            <span className="text-[16px] font-bold text-[#E5E5E5] mr-[8px]">자금 분리 —</span>
                            <span className="text-[16px] text-[#A1A1AA] leading-[26px]">
                    ...
                    <div className="flex items-start">
                        <span className="inline-flex min-w-[24px] text-[15px] font-bold text-[#86868B] mt-[2px]">3)</span>
                        <div>
                            <span className="text-[16px] font-bold text-[#E5E5E5] mr-[8px]">정보 분리 —</span>
                            <span className="text-[16px] text-[#A1A1AA] leading-[26px]">
