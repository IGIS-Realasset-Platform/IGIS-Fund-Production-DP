...
import tierImg from '../../../assets/5tier.webp';
        ...
        <div className="w-full flex flex-col pt-[77px] pb-[160px] max-w-[1112px] mx-auto">
            ...
            <div className="flex flex-col w-full mb-[32px]">
                ...
                <div className="flex flex-col">
                    <h3 className="text-[22px] font-bold text-[#7da2fb] mb-[8px]">1. 단일 진실의 원칙(Single Source of Truth)</h3>
                ...
                <div className="flex flex-col">
                    <h3 className="text-[22px] font-bold text-[#7da2fb] mb-[8px]">2. 결정자·승인자 분리 원칙(Two-Lock)</h3>
                ...
                <div className="flex flex-col">
                    <h3 className="text-[22px] font-bold text-[#7da2fb] mb-[8px]">3. UW 범위 안과 밖의 분리 원칙</h3>
                ...
                <div className="flex flex-col">
                    <h3 className="text-[22px] font-bold text-[#7da2fb] mb-[8px]">4. 이해상충 방화벽 원칙</h3>
                ...
                <div className="flex flex-col">
                    <h3 className="text-[22px] font-bold text-[#7da2fb] mb-[8px]">5. 기록과 복기의 원칙</h3>
            ...
            <h1 className="text-[36px] font-bold text-white tracking-tight leading-none font-['Inter'] mb-[16px] mt-[94px]">5 Tier 거버넌스 위계</h1>
            <p className="text-[16px] text-[#A1A1AA] leading-[26px] mb-[32px]">
                ...
                또한 시공사, 증권사, 대주단, LP 등 대외 커뮤니케이션은 혼선을 방지하기 위해 철저히 통제된 단일 창구(Single Point of Contact)를 통해서만 이루어집니다.
            </p>
