    ...
    return (
        <div className="w-full flex-1 flex flex-col pt-[77px] pb-[60px] max-w-[1112px] mx-auto">
            ...
            <div className="flex flex-col w-full gap-[24px]">
                {/* D+30 */}
                <div className="w-full bg-[#272726] border border-[#3c3c3c] rounded-[24px] px-[32px] pt-[22px] pb-[12px] hover:border-[#555] transition-colors">
                    <h2 className="text-[28px] font-black text-white tracking-tighter mb-0">D+30</h2>
                ...
                {/* D+60 */}
                <div className="w-full bg-[#272726] border border-[#3c3c3c] rounded-[24px] px-[32px] pt-[22px] pb-[12px] hover:border-[#555] transition-colors">
                    <h2 className="text-[28px] font-black text-white tracking-tighter mb-0">D+60</h2>
                ...
                {/* D+90 */}
                <div className="w-full bg-[#272726] border border-[#3c3c3c] rounded-[24px] px-[32px] pt-[22px] pb-[12px] hover:border-[#555] transition-colors">
                    <h2 className="text-[28px] font-black text-white tracking-tighter mb-0">D+90</h2>
