...
export default function WorkspaceDevelopment() {
    ...
    useEffect(() => {
        ...
        const saved = localStorage.getItem('iota_development_tasks_custom_assets');
    ...
    const registerNewAsset = () => {
        ...
        setTimeout(() => {
            ...
            localStorage.setItem('iota_development_tasks_custom_assets', JSON.stringify(updated));
    ...
    return (
        <div className="w-full flex-1 flex flex-col pt-[50px] pb-[60px] max-w-[1200px] mx-auto relative">
            ...
            <div className="flex justify-between items-center mb-[10px]">
                <h2 className="text-[18px] font-bold text-white tracking-tight">개발솔루션 주요 테스크 관리</h2>
