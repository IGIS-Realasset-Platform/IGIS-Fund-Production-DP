...
export default function WorkspaceDigital() {
    return (
        <div className="w-full flex-1 flex flex-col pt-[77px] pb-[60px] max-w-[1200px] mx-auto">
            <h1 className="text-[36px] font-bold text-white tracking-tight leading-none font-['Inter'] mb-[12px]">상품·디지털 Workspace</h1>
            <p className="text-[15px] text-[#86868B] mb-[36px]">디지털 트윈 적용 및 스마트 빌딩 상품 기획</p>
            ...
            <div className="w-full bg-[#1A1A1A] border border-[#333] rounded-[24px] p-[32px] flex flex-col items-center justify-center min-h-[300px]">
                ...
                <p className="text-[14px] text-[#86868B] text-center max-w-[400px]">이오타서울 통합 데이터룸에서 상품·디지털 셀의 세부 데이터가 스트리밍되면 이곳에 표시됩니다.</p>
            </div>
        </div>
    );
}
