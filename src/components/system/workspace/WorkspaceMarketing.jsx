    ...
    return (
            ...
            <div className="w-full bg-[#272726] border border-[#3c3c3c] rounded-[24px] mb-[40px]">
                <table className="w-full text-left table-fixed">
                    <thead>
                        <tr>
                            <th className="pl-[22px] pr-[16px] py-[16px] text-[13px] font-bold text-[#86868B] border-b border-[#3c3c3c] w-[23%] text-left">Task 명</th>
                            ...
                            <th className="pl-[80px] pr-[0px] py-[16px] text-[13px] font-bold text-[#86868B] border-b border-[#3c3c3c] w-[11%] text-center">마감일</th>
                    ...
                    <tbody className="divide-y divide-[#3c3c3c]">
                        {isAdding && (
                            <tr className="bg-[#272726]">
                                <td className="pl-[18px] pr-[12px] py-[12px]">
                        ...
                        {isLoading ? (
                            ...
                            (projectShowAll ? tasks : tasks.slice(0, 5)).map((row) => (
                                <tr key={row.id} className="hover:bg-[#272726] transition-colors group">
                                    <td className="pl-[22px] pr-[16px] py-[16px] text-[15px] font-bold text-white leading-snug text-left">{row.task_name}</td>
                                    <td className="px-[16px] py-[16px] text-[15px] font-bold text-white text-center">{row.company_name}</td>
                                    ...
                                    <td className="pl-[80px] pr-[0px] py-[16px] text-[13px] text-[#A1A1AA] font-['Inter'] text-center">{row.due_date}</td>
