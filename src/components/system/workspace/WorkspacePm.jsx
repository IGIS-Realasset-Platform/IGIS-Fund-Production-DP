                                    ...
                                    <div className="flex-1 min-w-0 pr-0 flex items-center gap-[8px] translate-x-[2px]">
                                        ...
                                        {log.raw_text && log.raw_text.length > 40 && (
                                            <button 
                                                ...
                                                className="bg-white/5 border border-[#333] hover:border-[#555] rounded-[6px] px-[6px] py-[4px] transition-colors text-[#86868B] hover:text-[#E5E5E5] cursor-pointer shrink-0 ml-[8px] w-[74px] flex items-center justify-center gap-[4px]"
                                            >
