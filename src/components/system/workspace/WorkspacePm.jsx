...
export default function WorkspacePm() {
    return (
        <div className="w-full flex-1 flex flex-col pt-[77px] pb-[60px] max-w-[1200px] mx-auto">
            <h1 className="text-[36px] font-bold text-white tracking-tight leading-none font-['Inter'] mb-[12px]">사업 PM Workspace</h1>
            <p className="text-[15px] text-[#86868B] mb-[36px]">일정 및 예산 슬리피지 관리 보드</p>
            ...
            <div className="w-full bg-[#1A1A1A] border border-[#333] rounded-[24px] p-[32px] flex flex-col items-center justify-center min-h-[300px]">
                ...
                <p className="text-[14px] text-[#86868B] text-center max-w-[400px]">이오타서울 통합 데이터룸에서 사업 PM 셀의 세부 데이터가 스트리밍되면 이곳에 표시됩니다.</p>
            </div>
        </div>
    );
}
