...
export default function WorkspacePmArchive() {
    ...
    const workspaces = [
        ...
        { id: 'digital', name: '공간솔루션-SSC', icon: <svg className="w-[18px] h-[18px] mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg> },
        ...
        ...workspace,
        name: normalizeIotaOrganization(workspace.name),
    }));
        ...
        <div className="flex h-screen w-full bg-[#1A1A1A] font-sans text-white overflow-hidden">
            ...
            <div className="w-[280px] bg-[#222] border-r border-[#333] flex flex-col h-full shrink-0 print:hidden">
                <div className="p-6 border-b border-[#333]">
                    <h1 className="text-[8px] font-bold tracking-tight text-white mb-4">지난 TASK 타임라인</h1>
