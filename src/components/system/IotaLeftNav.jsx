    ...
    return (
        <div className="w-[275px] h-full bg-transparent border-r border-[#2C2C2E] flex flex-col flex-shrink-0 text-[14px] font-sans text-white transition-colors duration-300">
            ...
            {memberInfo?.staff_name === '전기영' && (
                <div className="px-[15px] pb-3 w-full">
                    <div 
                        onClick={() => handleNavigation('platform/iotaseoul/pmo-vision')}
                        className={`flex items-center justify-center py-2 hover:bg-blue-500/10 rounded-md cursor-pointer transition-colors duration-300 border border-blue-500/40 text-blue-400 font-bold text-[13px] ${currentPath === 'platform/iotaseoul/pmo-vision' || currentPath === '/platform/iotaseoul/pmo-vision' ? 'bg-blue-500/20' : ''}`}
                    >
