    ...
    return (
        <div className="w-[275px] h-full bg-transparent border-r border-[#2C2C2E] flex flex-col flex-shrink-0 text-[14px] font-sans text-white">
            ...
            <div className="w-full flex items-center justify-between px-[15px] pt-[18px] pb-4">
                <span className="font-bold text-[20px] tracking-wide font-inter ml-[5px] text-white">IFPDP</span>
                <button className="text-[#c3c2b7] hover:text-white pb-1 group cursor-pointer mt-[4px]">
            ...
            <div className="flex-1 overflow-y-auto pb-5 hide-scrollbar flex flex-col px-[9px]">
                ...
                <div className="flex items-center px-2.5 py-2 hover:bg-[#2C2C2E] rounded-md cursor-pointer">
                ...
                <div className="flex items-center justify-between px-2.5 py-2 hover:bg-[#2C2C2E] rounded-md cursor-pointer mt-0.5">
                ...
                <div className="flex flex-col mt-0.5">
                    <div className="flex items-center justify-between px-2.5 py-2 bg-[#2A2A2A] rounded-md cursor-pointer">
                        <div className="flex items-center">
                    ...
                    <div className="flex flex-col mt-1 px-2.5 font-normal pl-[42px] gap-3 mt-3 pb-1 text-[#E5E5E5]">
                        <div className="hover:text-white cursor-pointer text-[14px]">
                            이지스 자산 임차 현황
                        </div>
                        <div className="hover:text-white cursor-pointer text-[14px]">
                            기업고객 관리
                ...
                <div className="flex items-center justify-between px-2.5 py-2 hover:bg-[#2C2C2E] rounded-md cursor-pointer mt-1.5">
                    <div className="flex items-center">
            ...
            <div className="px-[15px] py-3 border-t border-[#3A3A3C] w-full pb-4 flex items-center justify-between">
                <div className="flex items-center gap-3 hover:bg-[#2C2C2E] p-1.5 -ml-1.5 rounded-lg cursor-pointer">
