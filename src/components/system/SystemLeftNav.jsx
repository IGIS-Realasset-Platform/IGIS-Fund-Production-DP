    ...
    return (
        <div className="w-[275px] h-full bg-transparent border-r border-[#2C2C2E] flex flex-col flex-shrink-0 text-[14px] font-sans text-white">
            ...
            <div className="w-full flex items-center justify-between px-[15px] pt-[18px] pb-4">
                {/* IFPDP 로고 우측으로 5px 이동 */}
                <span className="text-white font-bold text-[20px] tracking-wide font-inter ml-[5px]">IFPDP</span>
                <button className="text-[#c3c2b7] hover:text-white pb-1 transition-colors group cursor-pointer mt-[4px]">
            ...
            {/* Main Menu */}
            {/* Reduced horizontal padding by 5px (px-[14px] -> px-[9px]) */}
            <div className="flex-1 overflow-y-auto pb-5 hide-scrollbar flex flex-col px-[9px]">
                
                <div className="flex items-center px-2.5 py-2 hover:bg-[#2C2C2E] rounded-md cursor-pointer text-white">
                ...
                <div className="flex items-center justify-between px-2.5 py-2 hover:bg-[#2C2C2E] rounded-md cursor-pointer mt-0.5 text-white">
                ...
                <div className="flex flex-col mt-0.5">
                    <div className="flex items-center justify-between px-2.5 py-2 hover:bg-[#2C2C2E] rounded-md cursor-pointer bg-[#2A2A2A] text-white">
                        <div className="flex items-center">
                            ...
                            <span className="font-normal text-[14px]">기업</span>
                        </div>
                    ...
                    <div className="flex flex-col mt-1 px-2.5 font-normal pl-[42px] gap-3 mt-3 pb-1 text-white">
                        <div className="hover:text-gray-300 cursor-pointer text-[14px]">
                            이지스 자산 임차 현황
                        </div>
                        <div className="hover:text-gray-300 cursor-pointer text-[14px]">
                            기업고객 관리
                ...
                <div className="flex items-center justify-between px-2.5 py-2 hover:bg-[#2C2C2E] rounded-md cursor-pointer mt-1.5 text-white">
                    <div className="flex items-center">
                        ...
                        <span className="font-light text-[14px]">유사솔루션</span>
                    </div>
                    <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" /></svg>
                </div>
                ...
                <div className="mt-8 mb-2 px-2.5">
                    ...
                    <div className="flex flex-col gap-2.5 mt-4 text-[#737373]">
                        {[
                            ...
                            <div key={idx} className="font-medium text-[13px] hover:text-[#E5E5E5] cursor-pointer truncate">
                                {chat}
                            </div>
                        ))}
                    </div>
