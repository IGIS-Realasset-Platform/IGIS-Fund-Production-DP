...
1. Phase 1 구축 배경 및 목적
   ...
   1) IFPDP 전사 프레임워크와의 연동
    이오타(IOTA) CFT 협업 플랫폼은 이지스자산운용의 전사 통합 자산 관제 및 의사결정 메타데이터 시스템인 IFPDP(IGIS Fund Production Data Platform)의 맥락과 설계 철학에서 출발했음. 
   ...
   2) 대형 프로젝트에 대한 전통적 업무 방식의 한계
    이오타 사업단 내의 각 전문 부서(사업관리, LFC, 개발관리, 마케팅, 설계 등)는 담당하는 대형 프로젝트(예: 427 PFV 등)는 복잡도가 높고 산출물이 얽혀 있어, 
...
4. 의사결정 맥락 기록
- 중요 의사결정 사항의 배경 사유와 정성적 판단 근거를 기록하는 의사결정 로그(DecisionLog) 및 히스토리 잠금.`)} className="px-3 py-1 bg-white border border-gray-300 hover:bg-gray-50 rounded-none text-[11.5px] font-medium text-black transition-all cursor-pointer" style={interFont}>
                                {copied ? 'Copied' : 'Copy Text'}
                            </button>
                        </header>
