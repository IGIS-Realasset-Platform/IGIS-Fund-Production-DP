...
export default function PmoVision() {
    ...
    // Restructured Data Map - Loading exact text from Google Sheets
    const contentMap = {
        'ifpdp-proposal': {
            title: 'IFPDP 시스템 기획안',
            subtitle: '부서 간 데이터 통합 및 의사결정 지원을 위한 전사 자산 관제 시스템 설계안 (구글 시트 원본)',
            content: `
 | IFPDP 시스템 기획안
...
`
        ...
        'ifpdp-requirements': {
            title: 'IFPDP 기능요구사항',
            subtitle: '전사 자산 관제 및 의사결정 지원 플랫폼의 핵심 기능 명세 (구글 시트 원본)',
            content: ` | IPFDP 기능요구사항 Draft (시연용 초기모델) |  |  |  |  |  |  |  |  |  | 사용자의 분류
 | 이지스 내/외 | 대분류 | 분류 | 엑터 |  | 기능상세 | Main 부서 | Sub 부서 | 비고 |  | Tier 1 | Tier 2 | Tier 3
 | 내부 | 그룹 정보 | 사업 매출 | Tier 3는 | 리얼에셋 그룹 및 조직의 매출 목표와 현재 달성 현황을 확인 할 수 있다.  |  | 투자/사업 | All |  |  | manager | s.manager | 파트장 이상
 | 내부 | 그룹 정보 | 센터 OKR | Tier 3는 | 각 센터의 OKR 계획과 진척도 현황을 확인 할 수 있다. |  | All 센터 | All
 | 내부 | 그룹 정보 | 인력 배분 정보 | Tier 3는 | 각 프로젝트에 할당 된 인력 배분 정보를 확인 할 수 있다.  |  | ALL | -
 | 내부 | 소싱 정보 | 입찰 접수현황 | Tier 2는 | 티저로 접수되는 입찰 접수건의 정보와 수량를 파악할 수 있다.  |  | 투자/사업 | All
 | 내부 | 소싱 정보 | CA 검토 현황 | Tier 3는 | CA 검토되는 프로젝트의 히스토리와 현황을 파악할 수 있다.  |  | 투자/사업 | All
 | 내부 | 소싱 정보 | 실사 현황 | Tier 3는 | 프로젝트의 실사 히스토리와 현재 실사 현황을 파악할 수 있다.  |  | 투자/사업 | All
 | 내부 | 소싱 정보 | 우협 선정 | Tier 3는 | 각 부서의 프로젝트 소싱 및 우협선정 히스토리를 파악할 수 있다.  |  | 투자/사업 | All
 | 내부 | 투자자 정보 | 투자자 통합정보 | Tier 3는 | 이지스에 투자된 투자사 통합 현황 대시보드를 편리하게 확인할 수 있다.  |  | 투자/사업 | All | 기관유형, 기관명, 이지스 투자 자산, 투자액 등
 |  |  |  |  |  | 중요도 우선순위 높은 프로젝트를 구분할 수 있다. (Tier 1, 2, 3)
 |  |  |  |  |  | 각 주제에 따른 프로젝트의 개수와 분포도를 확인 할 수 있다.  |  |  | 1티어와 2티어는 몇개이고 몇대몇인가.  커머셜/리빙/복합 분류, 시물인가 개발인가. 
 | 내부 | 투자자 정보 | 투자자 통합정보 | Tier 3는 | 개별 투자사에 대한 투자사 현황을 편리하게 확인할 수 있다.  |  | 투자/사업 | All | 조직도, 이지스 투자 자산, 자산별 투자액, 총 투자 가용액 등
 | 내부 | 투자자 정보 | 투자자 담당자  | Tier 3는 | 각 투자사의 담당자 및 키맨 정보, 및 커뮤니케이션 히스토리, 특이사항 등을 확인할 수 있다.  |  | 투자/사업 | All
 | 내부 | 자산통합정보 | 10단계 가치사슬 | Tier 3는 | 모든 프로젝트의 10단계 가치사슬 단계 및 특이사항 현황을 한 화면의 대시보드로 확인 할 수 있다. |  | ALL | -
 | 내부 | 자산통합정보 | 프로젝트 개수 | Tier 3는 | 현재 진행중인 프로젝트의 갯수를 다양한 분류방법을 통해 편리하게 확인 할 수 있다. |  | ALL | - | 프로젝트 총합, 착공전/착공후, 개발/실물, 투자/사업 파트 보유수 등
 | 내부 | 자산통합정보 | 설계/시공사 정보 | Tier 2는 | 프로젝트별 담당 설계사, 시공사, 담당자 연락처 및 담당자별 특징을 확인 할 수 있다. |  | 투자, 사업 | All 센터
 | 내부 | 복합/개별 자산 | 자산 통합 정보 | Tier 3는 | 모든 개별 자산의 10단계 가치사슬 전체 상황 및 특이사항 현황을 확인할 수 있다. |  | ALL | - | 10단계 가치사슬 : 소싱-투자-펀드생성-개발추진-파이낸싱-유저솔루션-기업마케팅-개발관리-준공-운용
 | 내부 | 복합/개별 자산 | 소싱 | Tier 2는 | 모든 개별 자산의 소싱 히스토리와 현재 현황을 확인할 수 있다.  |  | 투자 | CM | 히스토리 항목 정의 및 시계열 스냅샷 정책 수립
 | 내부 | 복합/개별 자산 | 투자 | Tier 2는 | 모든 개별 자산의 투자(심의) 히스토리와 현재 현황을 확인할 수 있다.  |  | 투자 | CM
 | 내부 | 복합/개별 자산 | 브랜드 | Tier 2는 | 모든 개별 자산의 브랜드(컨셉,포지셔닝) 히스토리와 현재 현황을 확인할 수 있다.  |  | 사업 | 공간솔루션
 | 내부 | 복합/개별 자산 | CF | Tier 2는 | 모든 개별 자산의 CF 히스토리와 현재 현황을 확인할 수 있다.  |  | 사업 | 투자
 | 내부 | 복합/개별 자산 | Finanacing | Tier 2는 | 모든 개별 자산의 Financing 히스토리와 현재 현황을 확인 할 수 있다.  |  | 사업 | LFC
 | 내부 | 복합/개별 자산 | PFV/펀드 운영 | Tier 2는 | 모든 개별 자산의 PFV/Fund 운영 히스토리와 현재 현황을 확인 할 수 있다.  |  | 사업 | 준법,리스크..
 | 내부 | 복합/개별 자산 | 개발 공정 | Tier 2는 | 모든 개별 자산의 공정/인허가 히스토리와 현재 현황을 확인 할 수 있다.  |  | 사업 | 개발솔루션 | 전력공급 포함
 | 내부 | 복합/개별 자산 | 상품기획 | Tier 2는 | 모든 개별 자산의 [공간UX/Tech] 상품 기획 히스토리와 현재 현황을 확인 할 수 있다.  |  | 사업 | 공간솔루션
 | 내부 | 복합/개별 자산 | 호텔 상품 개발 | Tier 2는 | 모든 개별 자산의 [호텔/레지던스] 상품 개발 히스토리와 현재 현황을 확인 할 수 있다.   |  | 사업 | 공간솔루션
 | 내부 | 복합/개별 자산 | 리테일 | Tier 2는 | 모든 개별 자산의 [리테일] 상품 개발 히스토리와 현재 현황을 확인 할 수 있다.  |  | 사업 | 리테일솔루션
 | 내부 | 복합/개별 자산 | 마케팅 | Tier 2는 | 모든 개별 자산의 마케팅 히스토리와 현재 현황을 확인 할 수 있다.  |  | 사업 | 기업마케팅
 | 내부 | 복합/개별 자산 | 마케팅 | Tier 2는 | 모든 개별 자산의 플레이스메이킹 히스토리와 현재 현황을 확인 할 수 있다.  |  | 사업 | 공간솔루션
 | 내부 | 복합/개별 자산 | 자산 스팩 | Tier 2는 | 모든 개별 자산의 스팩 히스토리와 현재 현황을 확인 할 수 있다.  |  | 사업 | 공간솔루션 | 스팩 : 건축개요, 구조, 평면도, 자재, 설비, 소방, OS, 수전, 공조, 통신, 친환경 인증 등 
 | 내부 | 복합/개별 자산 | 자산 스팩 | Tier 2는 | 모든 개별 자산의 전력공급 히스토리와 현재 현황을 확인 할 수 있다.  |  | 사업 | 개발솔루션
 | 내부 | 복합/개별 자산 | 자산 스팩 | Tier 2는 | 모든 개별 자산의 관리/운영 히스토리와 현재 현황을 확인 할 수 있다.  |  | 관리운영 | All 센터 | 관리/운영 : 리징, 임대료, 공실률, 자본 지출 내역, 에너지효율지표 등
 | 내부 | 복합/개별 자산 | 세일즈 | Tier 2는 | 모든 개별 자산의 세일즈(리징) 히스토리와 현재 현황을 확인 할 수 있다.  |  | 사업 | 기업마케팅
 | 내부 | 기업통합정보 | 세일즈 | Tier 2는 | 기업 관점에서 이지스 자산에 임차된 기업의 통합 현황을 편리하게 확인 할 수 있다.  |  | 기업마케팅 | ALL
 | 외부 | 시공/설계사 | 도급순위 및 이슈 | Tier 2는 | 시공사별 도급순위와 현재 시점에서의 시공사별 이슈, 담당자 연락처 및 담당자별 특징을 확인 할 수 있다. |  | 투자, 사업 | All 센터
 | 외부 | 기업통합정보 | 기업 임차정보 | Tier 2는 | 다양한 조건을 통해 기업의 오피스/데이터센터/물류 임차 현황을 확인 할 수 있다.  |  | 기업마케팅 | ALL | ex) 5만평 이상 오피스에 입주한 기업, 국내 500대 기업의 임차현황, 직원 1000명 이상 기업 현황 등
 | 외부 | 기업통합정보 | 기업 임차정보 | Tier 2는 | 특정 기업이 임차한 자산의 세부정보를 확인 할 수 있다.  |  | 기업마케팅 | ALL
 | 외부 | 기업통합정보 | 유형별 기업 형태 | Tier 2는 | 특정 기업유형에 따른 자산 환경 니즈를 확인 할 수 있다.  |  | 기업마케팅 | ALL | 기업 유형의 예) 법무법인, 컨설팅펌, 바이오기업, 테크기업
 | 외부 | 기업통합정보 | 기업 별 니즈 | Tier 2는 | 국내 Top 100 기업에 대해, 각 기업이 처한 고유한 환경과 임차 니즈를 확인 할 수 있다.  |  | 기업마케팅 | ALL
 | 외부 | 기업통합정보 | 기업 담장자 정보 | Tier 2는 | 주요 기업들의 메인컨텍포인트, 연락처, 해당 인물에 대한 현재 이슈, 특이사항 등을 확인 할 수 있다.  |  | 기업마케팅 | ALL
 | 외부 | 복합/개별 자산 | 매입/매각정보 | Tier 2는 | 3대권역 주요 자산의 매입/매각 히스토리와 현재 현황을 확인 할 수 있다.  |  | 투자/사업 | All
 | 외부 | 투자자 정보 | 투자자 통합정보 | Tier 2는 | LP 별 투자 현황 및 특이사항 등을 확인 할 수 있다. 
 | 외부 | 마켓/섹터 정보 |  | Tier 2는
 |  |  |  | Tier 2는
 |  |  |  | Tier 2는
 |  |  |  | Tier 2는
 ...
 |  |  |  | Tier 2는`
        ...
        'ifpdp-schema': {
            ...
            subtitle: 'IFPDP 전사 7대 핵심 데이터베이스 테이블 및 컬럼 모델 설계서 (구글 시트 원본)',
            content: ` | IFPDP Asset Data Schema v2.0 (다중 필드/시계열 반영)
...
`
        ...
        'phase1-proposal': {
            ...
            subtitle: '이오타 사업단 업무 통합 및 핵심 비히클 시계열 관제 프레임워크 구축 완료 보고 (구글 시트 원본)',
            content: `
...
`
        ...
        'phase1-requirements': {
            ...
            content: `IOTA CFT Phase 1 기능요구사항 명세
...
4. 의사결정 맥락 기록
- 중요 의사결정 사항의 배경 사유와 정성적 판단 근거를 기록하는 의사결정 로그(DecisionLog) 및 히스토리 잠금.`
        },
        'phase1-schema': {
            title: 'IOTA CFT Phase 1 DB Schema',
            subtitle: 'Phase 1 협업 및 비히클 시계열 관리를 위한 핵심 테이블 설계서',
            content: `-- 1. 이오타 파트별 태스크 테이블
...
CREATE TABLE public.iota_decision_logs (
    ...
    created_at TIMESTAMPTZ DEFAULT NOW()
        ...
        'phase2-proposal': {
            ...
            content: `IOTA CFT Phase 2 시스템 기획안
...
업무 현황 최신화를 신속히 수행할 수 있도록 스프레드시트 방식의 인라인 편집 및 Blocker 원클릭 토글을 지원하고, 우선순위가 높거나 Blocker가 켜진 안건을 회의실 화면에 즉시 A등급으로 상단 노출시키는 실시간 대시보드 연동을 설계했습니다.`
        ...
        'phase2-requirements': {
            ...
            content: `IOTA CFT Phase 2 기능요구사항 명세
                ...
                <div className="flex-1 overflow-y-auto p-12 hide-scrollbar">
                    <div className="max-w-[900px]">
                        ...
                        <div className="text-[15px] text-[#A1A1AA] leading-[28px] font-light whitespace-pre-wrap font-sans space-y-6">
                            {selectedMenu.endsWith('schema') || selectedMenu.endsWith('requirements') ? (
                                <pre className="bg-[#141416] p-6 rounded-2xl border border-[#1C1C1E] text-[13.5px] font-mono text-blue-300 overflow-x-auto whitespace-pre leading-relaxed select-text">
