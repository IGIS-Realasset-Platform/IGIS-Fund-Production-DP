            ...
            <div className="w-[1200px] mx-auto flex-1 flex flex-col pt-[77px]">
                ...
                <div className="w-full flex gap-[20px] mt-[6px]">
                    ...
                    <div className="w-[390px] h-[274px] flex flex-col gap-[20px]">
                        {/* Box 1 */}
                        <div className="w-full flex-1 bg-[#292928] rounded-[32px] flex flex-row items-center cursor-pointer group hover:bg-[#333] transition-colors duration-300">
                        ...
                        {/* Box 2 */}
                        <div className="w-full flex-1 bg-[#292928] rounded-[32px] px-6 pb-[8px] flex flex-row items-center cursor-pointer group hover:bg-[#333] transition-colors duration-300">
                    ...
                    <div className="flex-1 h-[274px] bg-[#292928] rounded-[32px] overflow-hidden relative flex flex-col cursor-pointer group hover:bg-[#333] transition-colors duration-300">
                        {/* Absolute Dividers */}
                            ...
                            <div className="relative flex flex-col justify-end px-[32px] pb-[32px]">
                                ...
                                <div className="flex items-end justify-end gap-3 w-full">
                                    ...
                                    <div className="flex flex-col items-end w-[138px] whitespace-nowrap">
                                        ...
                                        <span className="text-[28px] font-bold text-white tracking-tighter leading-none whitespace-nowrap">2조 1,964억</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="relative flex flex-col justify-end px-[32px] pb-[32px]">
                                ...
                                <div className="flex items-end justify-end gap-3 w-full">
                                    ...
                                    <div className="flex flex-col items-end w-[138px] whitespace-nowrap">
                                        ...
                                        <span className="text-[28px] font-bold text-white tracking-tighter leading-none whitespace-nowrap">2조 3,749억</span>
                                    </div>
                                </div>
                            </div>
                ...
                {/* Major Issues Box */}
                <div className="w-full bg-[#292928] rounded-[32px] pl-[24px] pr-[32px] py-[24px] flex flex-col mt-[20px] mb-[20px] h-[127px]">
                    ...
                    <div className="flex flex-col gap-[4px]">
                        <span className="text-[16px] font-medium text-[#86868B] leading-[22px] tracking-tight">
                ...
                <div className="w-full bg-[#292928] rounded-[32px] pt-[20px] flex flex-col mb-[40px] overflow-hidden">
                    {/* Header Row */}
