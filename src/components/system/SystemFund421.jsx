                ...
                <div className="flex flex-col w-[500px]">
                    ...
                    <div className="w-full flex-1 flex flex-col border-t-[2px] border-[#666] border-b border-[#444]">
                        ...
                        <div className="flex-1 flex">
                            ...
                            <div className="flex-1 flex items-center px-4 py-2 text-[#E5E5E5] text-[14px] whitespace-nowrap">
                                {phase421 === 'new' ? (
                                    ...
                                    <>총 3,090억 <span className="text-[#86868B] ml-1">(A종 602억 / B종 620억 / C종 1,850억)</span></>
                                )}
                            </div>
                        </div>
                    </div>
                ...
                <div className="flex-1 flex flex-col">
                    ...
                    <table className="w-full flex-1 table-fixed text-left border-collapse border-y-[2px] border-t-[#666] border-b-[#444]">
                        ...
                        <tbody className="text-[13px] text-[#E5E5E5]">
                            ...
                            <tr className="border-b border-[#444]">
                                <td className="py-2 px-4 border-r border-[#444]">
                                    {phase421 === 'new' ? <span className="text-[#82A0BC] font-medium">주주대여</span> : '주주대여'}
                                </td>
                                <td className="py-2 px-4 text-right font-[Inter] tracking-tight border-r border-[#444]">
                                    {phase421 === 'new' ? <span className="text-[#82A0BC] font-medium">253,500</span> : '240,000'}
                                </td>
                            ...
                            <tr className="border-b border-[#444] bg-[#1c1c1e]/50">
                                <td className="py-2 px-4 font-bold text-center text-[#86868B] border-r border-[#444]">소계</td>
                                <td className="py-2 px-4 text-right font-bold text-[#A1A1AA] font-[Inter] tracking-tight border-r border-[#444]">{phase421 === 'new' ? '255,455' : '241,955'}</td>
                            ...
                            <tr className="bg-[#2A2A2A]">
                                ...
                                <td className="py-2 px-4 text-right font-bold text-[#0A84FF] text-[14.5px] font-[Inter] tracking-tight border-r border-[#444]">{phase421 === 'new' ? '314,555' : '301,055'}</td>
