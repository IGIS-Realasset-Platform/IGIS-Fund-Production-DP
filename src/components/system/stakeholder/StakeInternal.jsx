...
export default function StakeInternal() {
    ...
    const renderLeader = (name, title) => (
        <div className="flex items-center gap-[12px]">
            <div className="w-[36px] h-[36px] shrink-0 rounded-full bg-[#3c3c3c] flex items-center justify-center border border-[#555] overflow-hidden">
                ...
                <table className="w-full text-left bg-transparent border-collapse table-fixed">
                    <thead>
                        <tr>
                            ...
                            <th className="pl-[18px] pr-[30px] py-[16px] text-[13px] font-normal text-[#86868B] border-b border-[#333]  w-[220px] bg-transparent">책임인력</th>
                            <th className="pl-[4px] pr-[44px] py-[16px] text-[13px] font-normal text-[#86868B] border-b border-[#333] border-r border-[#333] bg-transparent">실무인력</th>
                    ...
                    <tbody>
                        ...
                        <tr className="border-b border-[#333]">
                            ...
                            <td className="pl-[18px] pr-[30px] py-[16px] ">
                                {renderLeader('이철승', '부문대표')}
                            </td>
                            <td className="pl-[4px] pr-[44px] py-[16px] text-[13px] text-[#bbb9af] border-r border-[#333]">CFT 사무국 (신설 / 기획추진센터 IEC 협업)</td>
                        ...
                        <tr>
                            ...
                            <td className="pl-[18px] pr-[30px] py-[16px] border-b border-[#333]">
                                {renderLeader('권순일', '사업1파트장')}
                            </td>
                            <td className="pl-[4px] pr-[44px] py-[16px] text-[13px] border-r border-b border-[#333] leading-[22px]"><div className="flex flex-wrap gap-x-3 gap-y-1">{renderMembers('윤주형 김제익 류홍 박만진 박일훈 이정원 전무경')}</div></td>
                        ...
                        <tr className="border-b border-[#333]">
                            ...
                            <td className="pl-[4px] pr-[44px] py-[16px] text-[13px] border-r border-[#333] leading-[22px]"><div className="flex flex-wrap gap-x-3 gap-y-1">{renderMembers('한찬호 박석제 박채현 소현준 이수정 조영비 한수정')}</div></td>
                        </tr>
                        ...
                        <tr className="border-b border-[#333]">
                            ...
                            <td className="pl-[4px] pr-[44px] py-[16px] text-[13px] border-r border-[#333] leading-[22px]"><div className="flex flex-wrap gap-x-3 gap-y-1">{renderMembers('강석민 정리훈 손유정 김지우 박현승 이성민 한승환')}</div></td>
                        ...
                        <tr className="border-b border-[#333]">
                            ...
                            <td className="pl-[18px] pr-[30px] py-[16px]  align-top">
                                {renderLeader('홍장군', '개발솔루션센터장')}
                            </td>
                            <td className="pl-[4px] pr-[44px] py-[16px] text-[13px] text-[#bbb9af] border-r border-[#333] leading-[24px]">
                        ...
                        <tr>
                            ...
                            <td className="pl-[4px] pr-[44px] py-[16px] text-[13px] border-r border-b border-[#333] leading-[22px]"><div className="flex flex-wrap gap-x-3 gap-y-1">{renderMembers('이가현 정수명')}</div></td>
                        ...
                        <tr className="border-b border-[#333]">
                            ...
                            <td className="pl-[4px] pr-[44px] py-[16px] text-[13px] border-r border-[#333] leading-[22px]"><div className="flex flex-wrap gap-x-3 gap-y-1">{renderMembers('신민호')}</div></td>
                        </tr>
                        ...
                        <tr className="border-b border-[#333]">
                            ...
                            <td className="pl-[4px] pr-[44px] py-[16px] text-[13px] text-[#bbb9af] border-r border-[#333] leading-[22px]">KAM 1파트 실무진</td>
                        ...
                        <tr>
                            ...
                            <td className="pl-[4px] pr-[44px] py-[16px] text-[13px] text-[#bbb9af] border-r border-b border-[#333] leading-[22px]">사업1파트 실무진</td>
                        ...
                        <tr className="border-b border-[#333]">
                            ...
                            <td className="pl-[4px] pr-[44px] py-[16px] text-[13px] text-[#bbb9af] border-r border-[#333] leading-[22px]">신규 영입 예정</td>
                        </tr>
                        ...
                        <tr className="border-b-0">
                            ...
                            <td className="pl-[4px] pr-[44px] py-[16px] text-[13px] text-[#bbb9af] border-r border-[#333] leading-[22px]">사업1파트 실무진</td>
