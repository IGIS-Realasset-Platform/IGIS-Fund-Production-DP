...
export default function VehicleIntegrated() {
    ...
    return (
        <div className="w-[1200px] mx-auto flex-1 flex flex-col pt-[77px] shrink-0 pb-[100px]">
            ...
            {/* 1. 종합 */}
            <div className="mb-12">
                <h1 className="text-[36px] font-bold text-white tracking-tight leading-none font-['Inter'] mb-[12px]">통합 Vehicle 파이낸싱 구조</h1>
                <p className="text-[16px] text-[#86868B] mb-[40px] leading-[26px]">IOTA Seoul 프로젝트 전체의 자본 구조 및 펀드별 에쿼티/론 조달 현황입니다.</p>
