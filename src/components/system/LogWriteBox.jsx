...
{/* Text Area */}
                <div className={`w-full px-[20px] ${isTaskBoard ? 'pt-[16px] pb-[18px]' : 'pt-[20px] pb-[24px]'} bg-transparent ${editMode ? 'border-b border-[#333] pb-[20px] mb-[0] relative' : ''}`}>
                    ...
                    <textarea
                        ...
                        className="w-full bg-transparent text-transparent caret-white outline-none resize-y h-[100px] leading-relaxed text-[15px] relative z-10 font-sans p-0 border-0 m-0 box-border"
