...
export default function Section15({ isActive }) {
    ...
    return (
        <section className="relative section w-full h-full flex flex-col overflow-hidden bg-[#f4f4f5] text-[#1d1d1f]">
            ...
            <div className="w-[calc(100%-48px)] md:w-[calc(100%-100px)] max-w-[1400px] h-full mx-auto flex flex-col pt-24 md:pt-[7%] pb-10">
                ...
                <div className="relative flex-1 w-full max-w-[1100px] mx-auto hidden md:block mt-2 lg:mt-6 z-10">
                    ...
                    {/* The Hub Center */}
                    <div className={`absolute top-[40%] left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white px-10 py-5 rounded-none border-2 border-black shadow-none z-30 flex flex-col items-center justify-center transition-all duration-1000 ease-[cubic-bezier(0.25,1,0.5,1)] ${step >= 3 ? 'opacity-100 scale-100' : 'opacity-0 scale-75'}`}>
                    ...
                    {/* Left Line */}
                    <div className={`absolute top-[40%] right-[50%] w-[22%] h-[2px] bg-black origin-right transition-transform duration-[1200ms] ease-[cubic-bezier(0.25,1,0.5,1)] z-10 ${step >= 4 ? 'scale-x-100' : 'scale-x-0'}`}></div>
                    
                    {/* Right Line */}
                    <div className={`absolute top-[40%] left-[50%] w-[22%] h-[2px] bg-black origin-left transition-transform duration-[1200ms] ease-[cubic-bezier(0.25,1,0.5,1)] z-10 ${step >= 4 ? 'scale-x-100' : 'scale-x-0'}`}></div>

                    {/* Bottom Line */}
                    <div className={`absolute top-[40%] left-1/2 w-[2px] h-[22%] bg-black origin-top transition-transform duration-[1200ms] ease-[cubic-bezier(0.25,1,0.5,1)] z-10 ${step >= 4 ? 'scale-y-100' : 'scale-y-0'}`}></div>

                    {/* Node 1: Left */}
                    <div className={`absolute top-[40%] left-[11%] lg:left-[13%] -translate-y-1/2 w-[30%] max-w-[320px] bg-white pt-8 pb-7 px-8 rounded-none border-2 border-black shadow-none text-left flex flex-col transition-all duration-1000 ease-out z-20 ${step >= 5 ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'}`}>
                    ...
                    {/* Node 2: Right */}
                    <div className={`absolute top-[40%] right-[11%] lg:right-[13%] -translate-y-1/2 w-[30%] max-w-[320px] bg-white pt-8 pb-7 px-8 rounded-none border-2 border-black shadow-none text-left flex flex-col transition-all duration-1000 ease-out z-20 ${step >= 6 ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-8'}`}>
                    ...
                    {/* Node 3: Bottom */}
                    <div className={`absolute top-[68%] left-1/2 -translate-x-1/2 -translate-y-1/2 w-[30%] max-w-[340px] bg-white pt-8 pb-7 px-8 rounded-none border-2 border-black shadow-none text-left flex flex-col transition-all duration-1000 ease-out z-20 ${step >= 7 ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-8'}`}>
                ...
                <div className={`flex flex-col md:hidden w-full mt-10 space-y-6 pb-12 transition-all duration-1000 ease-out ${step >= 3 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                    ...
                    <div className={`bg-white p-6 rounded-none border-2 border-black shadow-none text-center relative z-20`}>
                        <span className="text-[12px] font-bold tracking-widest text-[#86868b] uppercase mb-1">Hub Component</span>
                    ...
                    <div className={`w-[2px] h-10 bg-black mx-auto transition-transform origin-top duration-[1500ms] ease-out ${step >= 4 ? 'scale-y-100' : 'scale-y-0'}`}></div>

                    <div className={`bg-white pt-6 pb-6 px-6 rounded-none border-2 border-black shadow-none flex flex-col items-start transition-all duration-1000 ease-out delay-[100ms] ${step >= 5 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
                    ...
                    <div className={`bg-white pt-6 pb-6 px-6 rounded-none border-2 border-black shadow-none flex flex-col items-start transition-all duration-1000 ease-out delay-[200ms] ${step >= 6 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
                    ...
                    <div className={`bg-white pt-6 pb-6 px-6 rounded-none border-2 border-black shadow-none flex flex-col items-start transition-all duration-1000 ease-out delay-[300ms] ${step >= 7 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
