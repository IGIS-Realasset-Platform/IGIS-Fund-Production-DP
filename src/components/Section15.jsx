...
export default function Section15({ isActive }) {
    ...
    return (
        <section className="relative section w-full h-full flex flex-col overflow-y-auto overflow-x-hidden bg-[#fafafc] text-[#1d1d1f] pt-[80px] pb-[100px] md:pt-[120px] md:pb-[140px] items-center">
            ...
            <div className="w-full max-w-[1400px] px-6 md:px-12 flex flex-col items-center justify-center my-auto shrink-0">
                                ...
                                <React.Fragment key={`node-${i}`}>
                                    ...
                                    >
                                        <div className="origin-center" style={{ animation: 'orbitSpinReverse 60s linear infinite' }}>
                                            <div className="text-[13px] lg:text-[15px] font-bold text-[#1d1d1f] whitespace-nowrap leading-none tracking-tight bg-white/20 backdrop-blur-sm border border-gray-200/80 px-4 py-2 lg:px-5 lg:py-2.5 rounded-[10px] shadow-[0_4px_16px_rgba(0,0,0,0.06)]" 
