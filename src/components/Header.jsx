    ...
    return (
        <>
            <header id="main-header"
                className="fixed top-0 left-0 bg-white text-black z-50 py-[5px] md:py-[15px] transition-transform duration-[800ms] ease-[cubic-bezier(0.16,1,0.3,1)]"
                            ...
                            >
                                <div className="w-[calc(100%-48px)] md:w-[calc(100%-100px)] max-w-[1600px] mx-auto pt-10 pb-[40px] flex justify-start gap-[120px]">
                                    {currentMenuData.map((col, idx) => (
                                        ...
                                        >
                                            <h4
                                                className="text-[16px] xl:text-[18px] font-medium mb-5 tracking-normal text-black w-fit cursor-pointer font-guardian"
                                                onClick={(e) => {
                                                    setIsMegaMenuOpen(false);
                                                    if (col.type === 'news') {
                                                        e.preventDefault();
                                    ...
                                    <div className="ml-auto flex flex-col items-end gap-[6px] text-[#888] font-bold text-[12px] md:text-[13px] tracking-tight mt-0 pb-[2px]">
