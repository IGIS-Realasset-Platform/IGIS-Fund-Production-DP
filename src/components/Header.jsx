                            ...
                            >
                                <div className="w-[calc(100%-48px)] md:w-[calc(100%-100px)] max-w-[1600px] mx-auto pt-10 pb-[40px] flex justify-start gap-[120px]">
                                    ...
                                    <div className="ml-auto flex flex-col items-end gap-[6px] text-[#888] font-bold text-[12px] md:text-[13px] tracking-tight mt-0 pb-[2px]">
                                        ...
                                        <a href="?page=action-plan" className="cursor-pointer hover:text-black transition-colors mt-auto">
                                            Action plan (initial)
                                        </a>
                                    </div>
            ...
            <div id="mobile-menu"
                ...
                <div className="w-full flex-col flex-1 overflow-y-auto overscroll-contain px-6 py-2 hide-scrollbar flex items-start text-left">
                    ...
                    <div className="w-full flex flex-col border-t border-gray-100 pt-6 mt-2 mb-4 items-start text-left gap-3">
                        ...
                        <a href="?page=action-plan" className="text-[15px] font-bold text-gray-500 hover:text-black cursor-pointer transition-colors mt-2">
                            Action plan (initial)
                        </a>
                    </div>
